...
<html>
  <head>
    <title>Đồ Công Nghề</title>
    <meta charset="utf-8">
    @include('client2.layouts.head')
    <title>@yield('title', 'Shop')</title>
    <link rel="icon" href="{{asset('client/home/images/logo1.jpg ')}}" type="image/png">
  ...
  <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    @include('client2.layouts.svg')

    
      @include('client2.layouts.nav')


      @include('client2.layouts.carosel')
    ...
    @include('client2.layouts.shopour')
