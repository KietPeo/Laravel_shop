<meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('client/home/css/bootstrap.min.css')}} ">
    <link rel="stylesheet" type="text/css" href="{{asset('client/home/css/style.css')}}">
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    ...
    <!-- script
    ================================================== -->
    <script src="{{asset('client/home/js/modernizr.js')}}"></script>